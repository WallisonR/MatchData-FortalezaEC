...
export default function Dashboard() {
  ...
  const offensiveGoalsSummary = useMemo(() => {
    ...
    const g2Remaining = Math.max(
      0,
      100 - (points / OFFENSIVE_GOALS.g2Points) * 100
    );
    const g6Remaining = Math.max(
      0,
      100 - (points / OFFENSIVE_GOALS.g6Points) * 100
    );
    return {
      points,
      wins,
          ...
          <Table>
            <TableHeader className="bg-gray-50 dark:bg-white/5">
              <TableRow>
                ...
                <TableHead className="text-center">% faltante p/G2</TableHead>
                <TableHead className="text-center">% faltante p/G6</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
